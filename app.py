...
# Data storage
rooms = defaultdict(list)  # {room_id: [player1, player2]}
players = {}  # {socket_id: {'name': str, 'room': int}}
...
def handle_join(data):
    ...
    if player_name not in rooms[room_id]:
        ...
        # Send full update to all room members
        emit('room_update', {
...
def handle_kick(data):
    ...
    # Only host can kick (first player in room)
